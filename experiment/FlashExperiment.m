...
experiment_data = load([path, file]);

experiment_data = experiment_data.experiment_data;

if(size(experiment_data(1).intensity,1) > 25)
...
for i = (1:96)
    fprintf(fileID, '\t{');
    fprintf(fileID, '%4i,',  experiment_data(ceil(i/12), mod(i-1,12)+1).periods);
    fprintf(fileID, '},\n');
end
fprintf(fileID, '};\n\n');
...
for i = (1:96)
    fprintf(fileID, '\t{');
    fprintf(fileID, '%6i,',  experiment_data(ceil(i/12), mod(i-1,12)+1).offset);
    fprintf(fileID, '},\n');
end
fprintf(fileID, '};\n');
...
for i = (1:96)
    fprintf(fileID, '\t{');
    fprintf(fileID, '%6i,',  experiment_data(ceil(i/12), mod(i-1,12)+1).t_interpulse);
    fprintf(fileID, '},\n');
end
fprintf(fileID, '};\n');
...
for i = (1:96)
    fprintf(fileID, '\t{');
    fprintf(fileID, '%6i,',  experiment_data(ceil(i/12), mod(i-1,12)+1).t_pulse);
    fprintf(fileID, '},\n');
end
fprintf(fileID, '};\n');
