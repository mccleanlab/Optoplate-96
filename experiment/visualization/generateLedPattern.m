%% generateLedPattern
%   Returns the light intensities over time. Can be used to make custom
%   plots of LED patterns
% Parameters
%   Output
% - a[array of integer] - light intensities at timestep i
% - t[array of integer] - time in seconds for each timestep i
%   Input
