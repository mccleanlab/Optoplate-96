...
%       phase of subpulse
function [amplitude, time] = saveLedPattern(amplitude,... 
                        pulse_numb, pusle_start_time,...
                        pulse_high_time, pulse_low_time,... 
                        subpulse_high_time, subpulse_low_time)
    [amplitude, time] = generateLedPattern(amplitude, pulse_numb, pusle_start_time, pulse_high_time, pulse_low_time, subpulse_high_time, subpulse_low_time);
end
